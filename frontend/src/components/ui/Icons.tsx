...
export const Users: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><path d="M20 8v6" /><path d="M23 11h-6" />
  </svg>
);
...
export const Sparkles: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="m12 3-1.5 3L7 7.5l3 1.5L12 12l1.5-3L17 7.5l-3-1.5z"></path><path d="M5 14.5 3.5 16l-1.5-1.5 1.5-1.5L5 11.5l1.5 1.5L5 14.5z"></path><path d="M19 14.5 17.5 16l-1.5-1.5 1.5-1.5L19 11.5l1.5 1.5L19 14.5z"></path>
  </svg>
);
...
export const Hotel: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M18 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2Z"/><path d="M10 2v20"/><path d="M10 12H6"/><path d="M10 6H6"/><path d="M18 6h-4"/><path d="M18 12h-4"/><path d="M18 18h-4"/>
  </svg>
);
...
export const Wand2: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="m12.5 3-2.25 2.25.01-.01L3 12.5l2.25 2.25.01-.01L12.5 22l2.25-2.25-.01.01L22 12.5l-2.25-2.25-.01.01L12.5 3z"/><path d="m3 3 7.5 7.5"/><path d="m13.5 13.5 7.5 7.5"/>
  </svg>
);
...
export const ParkingSquare: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const UtensilsCrossed: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="m16 2-2.3 2.3a3 3 0 0 0 0 4.2l1.8 1.8-11.3 11.3"/><path d="m2 16 6-6"/><path d="m21.5 21.5-11.3-11.3"/><path d="m16 16 6-6"/>
  </svg>
);
